...
1. [为什么需要 LADRC](#1-为什么需要-ladrc)
2. [核心概念回顾](#2-核心概念回顾)
   - [2.1 积分器串联型](#21-积分器串联型)
   - [2.2 总扰动](#22-总扰动)
3. [LADRC 数学模型](#3-ladrc-数学模型)
   - [3.1 系统描述](#31-系统描述)
   - [3.2 线性扩张状态观测器](#32-线性扩张状态观测器)
   - [3.3 线性误差反馈控制律](#33-线性误差反馈控制律)
4. [离散化实现](#4-离散化实现)
   - [4.1 零阶保持法](#41-零阶保持法)
   - [4.2 一阶系统离散化](#42-一阶系统离散化)
   - [4.3 二阶系统离散化](#43-二阶系统离散化)
5. [参数整定方法](#5-参数整定方法)
   - [5.1 扰动补偿系数 b₀](#51-扰动补偿系数-b₀)
   - [5.2 控制器带宽 w_c](#52-控制器带宽-w_c)
   - [5.3 观测器带宽 w_o](#53-观测器带宽-w_o)
6. [代码实现](#6-代码实现)
   - [6.1 跟踪微分器](#61-跟踪微分器)
   - [6.2 扩张状态观测器](#62-扩张状态观测器)
   - [6.3 控制器集成](#63-控制器集成)
7. [工程实践指南](#7-工程实践指南)
   - [7.1 调试步骤](#71-调试步骤)
   - [7.2 常见问题](#72-常见问题)
