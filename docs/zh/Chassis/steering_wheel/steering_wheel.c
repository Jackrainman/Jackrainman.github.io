...
//     float wheel_angle[WHEEL_NUM] = {0};
//     float wheel_speed[WHEEL_NUM] = {0};
//     float len_chassis = sqrt(2) * steering_resolve_handle.radius;
//     if (steering_resolve_handle.halt) {
//         wheel_angle[0] = -PI / 4;
//         wheel_angle[1] = PI / 4;
//         wheel_angle[2] = PI / 4;
//         wheel_angle[3] = -PI / 4;
...
//     } else {
//         /*!< 转动点到四个轮子的距离*/
//         float d1 = two_dimensions(x, y, -len_chassis / 2, len_chassis / 2);
//         float d2 = two_dimensions(x, y, len_chassis / 2, len_chassis / 2);
//         float d3 = two_dimensions(x, y, -len_chassis / 2, -len_chassis / 2);
//         float d4 = two_dimensions(x, y, len_chassis / 2, -len_chassis / 2);

//         float theta1 =
//             fabs(PI / 2 - ACOS_F32(triangle_cosine_law(d1, len_chassis, d3)));
//         float theta2 =
//             fabs(PI / 2 - ACOS_F32(triangle_cosine_law(d2, len_chassis, d4)));
//         float theta3 =
//             fabs(PI / 2 - ACOS_F32(triangle_cosine_law(d3, len_chassis, d1)));
//         float theta4 =
//             fabs(PI / 2 - ACOS_F32(triangle_cosine_law(d4, len_chassis, d2)));
//         /* 四个轮子的角度在九个象限内±号不同 */
//         if (x < -len_chassis / 2 && y > len_chassis / 2) {
//             wheel_angle[0] = theta1;
//             wheel_angle[1] = theta2;
//             wheel_angle[2] = theta3;
//             wheel_angle[3] = theta4;

//             // wheel_speed[0] = v * d1 * 4 / (d1 + d2 + d3 + d4);
//             // wheel_speed[1] = v * d2 * 4 / (d1 + d2 + d3 + d4);
//             // wheel_speed[2] = v * d3 * 4 / (d1 + d2 + d3 + d4);
//             // wheel_speed[3] = v * d4 * 4 / (d1 + d2 + d3 + d4);

//             wheel_speed[0] = v * d1 * 4 / (d1 + d2 + d3 + d4);
//             wheel_speed[1] = v * d2 * 4 / (d1 + d2 + d3 + d4);
//             wheel_speed[2] = v * d3 * 4 / (d1 + d2 + d3 + d4);
//             wheel_speed[3] = v * d4 * 4 / (d1 + d2 + d3 + d4);
//         } else if (x > -len_chassis / 2 && x < len_chassis &&
//                    y > len_chassis / 2) {
//             wheel_angle[0] = -theta1;
//             wheel_angle[1] = theta2;
//             wheel_angle[2] = -theta3;
...
//         } else if (x > len_chassis / 2 && y > len_chassis / 2) {
//             wheel_angle[0] = -theta1;
//             wheel_angle[1] = -theta2;
//             wheel_angle[2] = -theta3;
//             wheel_angle[3] = -theta4;
...
//             wheel_speed[2] = v * d3 * 4 / (d1 + d2 + d3 + d4);
//             wheel_speed[3] = v * d4 * 4 / (d1 + d2 + d3 + d4);
//         } else if (x > -len_chassis / 2 && x < len_chassis / 2 &&
//                    y > -len_chassis / 2 && y < len_chassis / 2) {
//             wheel_angle[0] = theta1;
//             wheel_angle[1] = -theta2;
//             wheel_angle[2] = -theta3;
//             wheel_angle[3] = theta4;
...
//     }
//     /* 电机控制 */
//     steering_resolve_handle.steering_direction_ctrl(
//         steering_resolve_handle.set_wheel_angle);
//     steering_resolve_handle.steering_speed_ctrl(
//         steering_resolve_handle.set_wheel_speed);
// }