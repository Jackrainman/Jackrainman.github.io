...
- [通用的写作准则](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E9%80%9A%E7%94%A8%E7%9A%84%E5%86%99%E4%BD%9C%E5%87%86%E5%88%99)
- [写作风格](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E5%86%99%E4%BD%9C%E9%A3%8E%E6%A0%BC)
- [页面部件](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E9%A1%B5%E9%9D%A2%E9%83%A8%E4%BB%B6)
- [其他参考资料](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E5%85%B6%E4%BB%96%E5%8F%82%E8%80%83%E8%B5%84%E6%96%99)
...
- [考虑你的目标受众](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E8%80%83%E8%99%91%E4%BD%A0%E7%9A%84%E7%9B%AE%E6%A0%87%E5%8F%97%E4%BC%97)
- [考虑写作的“3C”准则](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E8%80%83%E8%99%91%E5%86%99%E4%BD%9C%E7%9A%84%E2%80%9C3c%E2%80%9D%E5%87%86%E5%88%99)
- [包含相关的示例](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E5%8C%85%E5%90%AB%E7%9B%B8%E5%85%B3%E7%9A%84%E7%A4%BA%E4%BE%8B)
- [提供描述性的介绍](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E6%8F%90%E4%BE%9B%E6%8F%8F%E8%BF%B0%E6%80%A7%E7%9A%84%E4%BB%8B%E7%BB%8D)
- [使用包容性语言](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E4%BD%BF%E7%94%A8%E5%8C%85%E5%AE%B9%E6%80%A7%E8%AF%AD%E8%A8%80)
- [写作时要带有 SEO 意识](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E5%86%99%E4%BD%9C%E6%97%B6%E8%A6%81%E5%B8%A6%E6%9C%89_seo_%E6%84%8F%E8%AF%86)
...
- **过于冗长的简介示例**：下面是上面那个简介的修改版，但是这次它又太过冗长了。其中包含了过多的细节，并且还包含了很多其他方法和属性，但实际上它应该将重点聚焦在 `strokeText()` 方法上，然后给出详细介绍它的文章的链接即可。
    ...
    > 
    > The text is drawn using the context's current font as specified in the context's [`font`](https://developer.mozilla.org/zh-CN/docs/Web/API/CanvasRenderingContext2D/font "font") property.
    > 
...
- **合适的介绍简介示例**：在这里，我们看到一个更好的 `strokeText()` 方法的概述。
    ...
    > The [`CanvasRenderingContext2D`](https://developer.mozilla.org/zh-CN/docs/Web/API/CanvasRenderingContext2D) method **`strokeText()`**, part of the [Canvas 2D API](https://developer.mozilla.org/zh-CN/docs/Web/API/Canvas_API), strokes (draws the outlines of) the characters of a specified string, anchored at the position indicated by the given X and Y coordinates. The text is drawn using the context's current [`font`](https://developer.mozilla.org/zh-CN/docs/Web/API/CanvasRenderingContext2D/font "font"), and is justified and aligned according to the [`textAlign`](https://developer.mozilla.org/zh-CN/docs/Web/API/CanvasRenderingContext2D/textAlign "textAlign"), [`textBaseline`](https://developer.mozilla.org/zh-CN/docs/Web/API/CanvasRenderingContext2D/textBaseline "textBaseline"), and [`direction`](https://developer.mozilla.org/zh-CN/docs/Web/API/CanvasRenderingContext2D/direction "direction") properties.
    > 
    > For more details and examples, see the [Text](https://developer.mozilla.org/zh-CN/docs/Learn_web_development/Extensions/Client-side_APIs/Drawing_graphics#%E6%96%87%E6%9C%AC) section on the Drawing graphics page as well as our main article on the subject, [Drawing text](https://developer.mozilla.org/zh-CN/docs/Web/API/Canvas_API/Tutorial/Drawing_text).
...
**备注：**MDN 允许在这里使用第三人称复数，也就是通常所说的“[单数形式的‘they’](https://zh.wikipedia.org/wiki/%E5%8D%95%E6%95%B0they)”。中性代名词包括：“they”、“them”、“their”和“theirs”。
...
虽然 MDN Web 文档上的任何写作的主要目标应该始终是解释和告知开放的 web 技术，以便开发人员能够迅速学会做他们想做的事情，或者找到他们需要知道的小细节，以完善他们的代码，但重要的是，他们能够_找到_我们写的材料。我们可以通过在写作时牢记搜索引擎优化（[SEO](https://developer.mozilla.org/zh-CN/docs/Glossary/SEO)）来实现这一点。
...
- **确保页面不会太短**：如果一个页面上的内容太少（在 SEO 术语中称为“薄页（thin page）”），搜索引擎将不会对这种页面进行准确的分类。内容过短的页面很难找到。作为一个指导原则，确保 MDN Web 文档上的页面内容不少于 300 字左右。不要人为地撑满一个页面，但在可能的情况下，将这一准则作为一个最小的目标长度。
    ...
    - **审查页面结构**：审查页面以确保它的结构对于[页面类型](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Page_structures/Page_types)来说是正确的。要确保它应该有的每一节都存在，并有适当的内容。
    ...
    - **增加例子**：应该有涵盖所有参数或至少是初级到中级用户可能使用的参数（或属性）的例子，以及任何需要额外解释的高级参数。每个例子前面都应该有一个概述，说明这个例子将做什么，理解它可能需要哪些额外的知识，等等。在例子之后（或穿插在例子的各个部分）应该有解释代码如何工作的文字。不要吝啬例子中的细节和对错误的处理。请记住，用户会复制和粘贴你的例子在他们自己的项目中使用，而你的代码也会在生产网站上使用！请参阅我们的[代码范例指南](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Code_style_guide)以获得更多有用的信息。
    - **解释用例**：如果所描述的功能有特别常见的用例，那就谈一谈吧！而不是假设用户会在使用过程中出现问题！与其假设用户会发现被记录的方法可以用来解决一个常见的开发问题，不如实际添加一个关于该用例的部分，并提供一个例子和解释该例子如何工作的文字。
    - **添加图片信息**：在所有的图像和图表上包括适当的 [`alt`](https://developer.mozilla.org/zh-CN/docs/Web/HTML/Reference/Elements/img#alt) 文本。这个文本，以及表格和其他数字的标题，都是重要的，因为网络蜘蛛不能抓取图像，所以 `alt` 文本告诉搜索引擎爬虫嵌入式媒体包含哪些内容。
...
- [缩写和缩略语](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E7%BC%A9%E5%86%99%E5%92%8C%E7%BC%A9%E7%95%A5%E8%AF%AD)
- [大写](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E5%A4%A7%E5%86%99)
- [口头缩略](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E5%8F%A3%E5%A4%B4%E7%BC%A9%E7%95%A5)
- [数字与数词](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E6%95%B0%E5%AD%97%E4%B8%8E%E6%95%B0%E8%AF%8D)
- [复数形式](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E5%A4%8D%E6%95%B0%E5%BD%A2%E5%BC%8F)
- [撇号和引号](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E6%92%87%E5%8F%B7%E5%92%8C%E5%BC%95%E5%8F%B7)
- [逗号](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E9%80%97%E5%8F%B7)
- [连字符](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E8%BF%9E%E5%AD%97%E7%AC%A6)
- [拼写形式](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E6%8B%BC%E5%86%99%E5%BD%A2%E5%BC%8F)
- [术语](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E6%9C%AF%E8%AF%AD)
- [语态](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E8%AF%AD%E6%80%81)

### [缩写和缩略语](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E7%BC%A9%E5%86%99%E5%92%8C%E7%BC%A9%E7%95%A5%E8%AF%AD)

缩写是一个较长单词的缩短版本，而首字母缩写是使用短语中每个单词的第一个字母创造的新单词。本节介绍了缩写和首字母缩写的准则。

- **扩展形式**：在页面中第一次提到一个术语时，要展开用户可能不熟悉的缩略语。如果有疑问，就展开它——或者更好的是，把它链接到描述该技术的文章或[术语表](https://developer.mozilla.org/zh-CN/docs/Glossary)条目。
...
- **拉丁文缩写**：你可以在括号内的表达和注释中使用常见的拉丁文缩写（如 etc.、i.e.、e.g.）。在这些缩写中使用句号，后面是逗号或其他适当的标点符号。
    ...
    **备注：**在使用前请仔细思考使用拉丁文缩写是否真的能带来好处。上面列出的某些缩写很少用到，很多读者可能不知道其意思，还有一些读者可能会分不清其中的某些缩写。
    ...
    另外，如果你决定使用缩写，那么请确保_你_的用法是正确的。比如，一个很多人经常会犯的错误是将“e.g.”和“i.e.”弄混。
...
对于键盘按键，应该使用普通的大写规则，而不是全大写。比如，是“Enter”而不是“ENTER”。不过你可以使用“ESC”作为“EScape”的缩写。

某些单词应始终大写（例如商标中的大写字母），或源自某人姓名的单词（除非它在代码中使用，并且代码的语法要求小写）。以下是一些例子：

- Boolean（其源自英国数学家和逻辑学家的姓名 [George Boole](https://zh.wikipedia.org/wiki/%E4%B9%94%E6%B2%BB%C2%B7%E5%B8%83%E5%B0%94)）
...
### [数字和数词](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E6%95%B0%E5%AD%97%E5%92%8C%E6%95%B0%E8%AF%8D)
...
**备注：**中文与英文的使用习惯是不同的，在翻译时，应该遵循[简体中文翻译指南 - 标点符号](https://github.com/mdn/translated-content/blob/main/docs/zh-cn/translation-guide.md#%E6%A0%87%E7%82%B9%E7%AC%A6%E5%8F%B7)中的有关说明。
...
- **在连接词之前**：串行逗号（也称为“牛津逗号”）是指在三个或更多项目的系列中出现在连词前的逗号。在 MDN Web 文档上，我们使用串行逗号。逗号还可以分隔列表中的每个项目。
    ...
    **备注：**这种情况在翻译成简体中文时应将逗号翻译为顿号。“简体中文翻译指南”一文的[标点符号](https://github.com/mdn/translated-content/blob/main/docs/zh-cn/translation-guide.md#%E6%A0%87%E7%82%B9%E7%AC%A6%E5%8F%B7)”一节中也提到了这个问题。
...
- **HTML 元素**：请使用“element”来表示 HTML 和 XML 元素，不要使用“tag”。另外，请在元素名称两边使用尖括号“<>”括起来，并使用 [`<code>`](https://developer.mozilla.org/zh-CN/docs/Web/HTML/Reference/Elements/code) 样式。
    ...
    - **正确**：[`<span>`](https://developer.mozilla.org/zh-CN/docs/Web/HTML/Reference/Elements/span) element
    - **错误**：span tag
...
- [代码示例](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E4%BB%A3%E7%A0%81%E7%A4%BA%E4%BE%8B)
- [外部链接](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E5%A4%96%E9%83%A8%E9%93%BE%E6%8E%A5)
- [短链接](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E7%9F%AD%E9%93%BE%E6%8E%A5)
- [标题级别](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E6%A0%87%E9%A2%98%E7%BA%A7%E5%88%AB)
- [图片及其他媒体](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E5%9B%BE%E7%89%87%E5%8F%8A%E5%85%B6%E4%BB%96%E5%AA%92%E4%BD%93)
- [列表](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E5%88%97%E8%A1%A8)
- [“参见”部分](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E2%80%9C%E5%8F%82%E8%A7%81%E2%80%9D%E9%83%A8%E5%88%86)
- [子页面](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E5%AD%90%E9%A1%B5%E9%9D%A2)
- [路径名](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E8%B7%AF%E5%BE%84%E5%90%8D)
- [标题](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E6%A0%87%E9%A2%98)
...
- 在添加[实时演示](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Page_structures/Live_samples)时，注意到包含样本的区域中的所有 [`<pre>`](https://developer.mozilla.org/zh-CN/docs/Web/HTML/Reference/Elements/pre) 块在运行样本前都被串联起来，这让你可以将任何或所有的 HTML、CSS 和 JavaScript 分成多个片段，每个片段可以选择有自己的描述、标题等。这使得撰写代码文档的功能非常强大和灵活。

要了解如何为 MDN Web 文档的代码示例设置样式或格式，请参见[代码示例样式指南](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Code_style_guide)。
...
在不跳级的情况下，按照递减的顺序使用这些 markdown 标记级别：`##`，然后是 `###`，然后是 `####`；这些分别翻译成 [HTML 标题标签](https://developer.mozilla.org/zh-CN/docs/Web/HTML/Reference/Elements/Heading_Elements)的 `<h2>`、`<h3>` 和 `<h4>` 标签。
...
MDN Web 文档上的大多数指南、参考页、甚至词汇表页都在文章的结尾处包含一个_参见_部分。这是一个参考部分，包含了 MDN 内相关主题的交叉引用，有时还包含了相关外部文章的链接。例如，这是 `@layer` 页面的[“参见”部分](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Reference/At-rules/@layer#%E5%8F%82%E8%A7%81)。

一般来说，在“参见”部分的链接以[项目符号列表](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E5%88%97%E8%A1%A8)格式呈现，列表中的每一项都是一个短语。然而，在 MDN 的[学习网页开发](https://developer.mozilla.org/zh-CN/docs/Learn_web_development)区域，“参见”部分遵循[定义列表](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Howto/Markdown_in_MDN#%E5%AE%9A%E4%B9%89%E5%88%97%E8%A1%A8)格式。

为了保持整个 MDN Web 文档的一致性，在添加或更新“参见”部分时，请记住以下准则。

#### 链接文字

- 链接文本应与被链接的页面或章节的标题相同。例如，这个 [ARIA](https://developer.mozilla.org/zh-CN/docs/Web/Accessibility/ARIA/Reference/Attributes) 页面的链接文本将是：
    - **正确**：[ARIA 状态和属性](https://developer.mozilla.org/zh-CN/docs/Web/Accessibility/ARIA/Reference/Attributes)
- 在链接文本中使用句子大小写，即使它与链接的页面标题或章节标题不同。这可能是页面或章节标题中使用的大小写不正确。例如，[WAI-ARIA 角色](https://developer.mozilla.org/zh-CN/docs/Web/Accessibility/ARIA/Reference/Roles)页面的链接文本将是：
    - **正确**：[WAI-ARIA 角色](https://developer.mozilla.org/zh-CN/docs/Web/Accessibility/ARIA/Reference/Roles)
- 对于外部链接也要使用句子的大小写，即使目标文章页面上的大小写不同。这是为了确保整个 MDN Web 文档的一致性。例外情况包括书籍的名称。
- 使用适当的宏来链接到[参考文档页面](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Page_structures/Macros/Commonly_used_macros#%E9%93%BE%E6%8E%A5%E5%88%B0_mdn_%E7%9A%84%E5%8F%82%E8%80%83%E6%96%87%E6%A1%A3%E9%A1%B5%E9%9D%A2)。使用宏将为链接文本中的关键词添加代码格式，如前面的例子所示。
- 链接列表项的开头不需要冠词（"A"、"An"、"The"）。链接文本后不需要标点符号，因为它必然是一个术语或一个短语。
    - **正确**：[`revert-layer`](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Values/revert-layer)。
    - **错误**：[`revert-layer`](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Values/revert-layer) 关键词。

#### 描述性文字

- 保持链接周围的描述性文字尽量少。如果有描述，就在链接文本和冒号之后添加。把描述写成一个短语，没有结尾的标点符号。将所有的链接文本放在开头，有助于粗读链接列表。
    - **正确**：[`:checked`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Reference/Selectors/:checked), [`:indeterminate`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Reference/Selectors/:indeterminate): CSS selectors for styling checkboxes
- 不要在系列的最后一个项目前使用连词“and”。
    - **正确**：[`background-color`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Reference/Properties/background-color), [`border-color`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Reference/Properties/border-color), [`color`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Reference/Properties/color), [`caret-color`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Reference/Properties/caret-color), [`column-rule-color`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Reference/Properties/column-rule-color), [`outline-color`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Reference/Properties/outline-color), [`text-decoration-color`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Reference/Properties/text-decoration-color), [`text-emphasis-color`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Reference/Properties/text-emphasis-color), [`text-shadow`](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Reference/Properties/text-shadow): Other color-related properties
...
例如，[JavaScript](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript) 指南的结构如下：

- [JavaScript/指南](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide)——主目录页
- [JavaScript/指南/JavaScript 概述](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide/Introduction)
- [JavaScript/指南/函数](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide/Functions)
- [JavaScript/指南/对象模型的细节](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Guide/Inheritance_and_the_prototype_chain)
...
页面标题在搜索结果中使用，也用于在页面顶部的面包屑列表中构建页面层次。页面标题可以不同于页面的路径名，这一点在[路径名](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E8%B7%AF%E5%BE%84%E5%90%8D)部分有解释。
...
- **通用原则**：决定你要记录什么，以及你将如何组织这些内容，是写作的第一步。写一个目录可以帮助你决定如何安排信息。先介绍简单的概念，然后再介绍更复杂和高级的概念。先讲概念性的信息，然后再讲面向行动的主题。
    ...
    - **由浅入深**：如[标题级别](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E6%A0%87%E9%A2%98%E7%BA%A7%E5%88%AB)部分所述，从较高的 `##` 到较低的 `####` 排布内容，中间不要跳级。使用较高层次的标题作为广泛的介绍性标题，并在进入较低层次的标题时使用更具体的标题。
...
### [其他样式指南](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E5%85%B6%E4%BB%96%E6%A0%B7%E5%BC%8F%E6%8C%87%E5%8D%97)
...
### [语言、语法和拼写](https://developer.mozilla.org/zh-CN/docs/MDN/Writing_guidelines/Writing_style_guide#%E8%AF%AD%E8%A8%80%E3%80%81%E8%AF%AD%E6%B3%95%E5%92%8C%E6%8B%BC%E5%86%99)
